...
_UserEntity _$UserEntityFromJson(Map<String, dynamic> json) => _UserEntity(
  ...
  accessCredits: (json['accessCredits'] as num?)?.toDouble() ?? 0,
  bonusAccess: (json['bonusAccess'] as num?)?.toDouble() ?? 0,
  hostBenefits: (json['winningBalance'] as num?)?.toDouble() ?? 0,
  canParticipate: json['canParticipate'] as bool? ?? false,
  interactionUnlocked: json['interactionUnlocked'] as bool? ?? false,
...
Map<String, dynamic> _$UserEntityToJson(_UserEntity instance) =>
    <String, dynamic>{
      ...
      'accessCredits': instance.accessCredits,
      'bonusAccess': instance.bonusAccess,
      'winningBalance': instance.hostBenefits,
      'canParticipate': instance.canParticipate,
      'interactionUnlocked': instance.interactionUnlocked,
