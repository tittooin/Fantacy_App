...
mixin _$UserEntity {
 ...
 String get uid; String? get email; String? get phoneNumber; String? get displayName; String? get photoUrl; String? get bio; String? get selectedState; bool get isRestricted; bool get isPhoneVerified; bool get isEmailVerified; bool get isKYCVerified; String? get kycStatus; double get walletBalance; double get bonusBalance; double get winningBalance; int get followersCount; int get followingCount; int get contestsPlayed; int get contestsWon;@TimestampConverter() DateTime? get createdAt;@TimestampConverter() DateTime? get lastLoginAt;
...
class _UserEntity implements UserEntity {
  const _UserEntity({required this.uid, this.email, this.phoneNumber, this.displayName, this.photoUrl, this.bio, this.selectedState, this.isRestricted = false, this.isPhoneVerified = false, this.isEmailVerified = false, this.isKYCVerified = false, this.kycStatus, this.walletBalance = 0, this.bonusBalance = 0, this.winningBalance = 0, this.followersCount = 0, this.followingCount = 0, this.contestsPlayed = 0, this.contestsWon = 0, @TimestampConverter() this.createdAt, @TimestampConverter() this.lastLoginAt});
