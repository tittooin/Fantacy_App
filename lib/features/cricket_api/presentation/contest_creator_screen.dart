            ...
            children: [
              ...
              Center(
                 child: ElevatedButton.icon(
                  ...
                  label: const Text("Auto Generate Payouts 🪄"),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("₹${_projectedProfit.toStringAsFixed(2)}", style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.green)),
                        ],
                      ),
                    ),
                  ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _buildSummaryRow("Total Collection", "₹${_totalCollection.toStringAsFixed(2)}"),
                    const SizedBox(height: 8),
